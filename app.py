...
with streamlit_analytics.track():
    ...
    if mode == "Single player":
        ...
        player2_name = st.sidebar.selectbox(
            ...
            player_names.index(config.template_to_position_mapping[template]["default_compare_player"]))
        st.pyplot(polar_plot_service.draw_polar2(df, player1_name, player2_name, template))
